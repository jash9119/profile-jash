...
function TimelineItem({ year, title, duration, details }) {
   return (
      <ol className="flex flex-col md:flex-row relative border-l border-amber-600 dark:border-gray-700">
         <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-amber-400 rounded-full mt-1.5 -left-1.5 border border-amber-700 dark:border-gray-900 dark:bg-gray-700" />
